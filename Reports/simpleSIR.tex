...
There are simply no credible data on either the Susceptible or
...
(\ref{eqn:sSIRfd}) is computed algebraically as
\begin{equation}
...
\begin{enumerate}
\item Effective suppression of transmission 
...
uncontrolled increase in number of new cases (eg Honolulu Co. HI,
Miami-Dade Co. FL);
\item Slow monotonic increase in number of new cases (eg.  Alameda Co. CA);
\item Partial suppression of transmission followed by 
uncontrolled increase in number of new cases (eg Dallas Co. TX);
\end{enumerate}
...
Observed and estimated cases and fits and estimated transmission rate
trend.}
\includegraphics[height=0.40\textheight]{../Graphics/Miami-DadeFL-2020-06-10.pdf}
\end{center}
\end{figure}
...
Observed and estimated cases and fits and estimated transmission rate
trend.}
\includegraphics[width=1.00\textwidth]{../Graphics/CookIL-2020-06-10.pdf}
\end{center}
\end{figure}
...
Observed and estimated cases and fits and estimated transmission rate
trend.}
\includegraphics[width=1.00\textwidth]{../Graphics/RiversideCA-2020-06-10.pdf}
\end{center}
\end{figure}
