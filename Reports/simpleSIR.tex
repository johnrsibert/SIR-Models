...
\begin{center}
\begin{tabular}{ll}
%\multicolumn{2}{c}{\includegraphics[width=1.00\textwidth]{../Graphics/New_York_CityNY_prevalence.png}}\\
...
\includegraphics[width=0.50\textwidth]{../Graphics/AlamedaCA_prevalence.png}&
\includegraphics[width=0.50\textwidth]{../Graphics/DallasTX_prevalence.png}\\
\end{tabular}
\end{center}
}
